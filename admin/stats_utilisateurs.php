...
// ── Données : nombre de PCs par utilisateur ───────────────────────────────────
...
<div class="container-fluid py-4">
  ...
  <div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h6 class="mb-0">Répartition des PCs (<?= count($rows) ?> entrée<?= count($rows) > 1 ? 's' : '' ?>)</h6>
          ...
          <tbody>
            ...
            <tr data-name="<?= e(strtolower($r['utilisateur'])) ?>">
              ...
              <td class="text-center">
                <?php if (!$isUnknown): ?>
                <a href="/pcs.php?search=<?= urlencode($r['utilisateur']) ?>" class="btn btn-sm btn-outline-primary" title="Voir les PCs de <?= e($r['utilisateur']) ?>">
